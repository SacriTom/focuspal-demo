...
IRIS Section 5.1 anchored the thread in research: *"guilt drives short-term compliance, not sustained change"* — supported by parental-screen-guilt research (Robb & Shellenbarger, 2024) and Self-Determination Theory's finding that controlled motivation fails to sustain after the intervention ends (Ryan & Deci, 2000). Section 5.1 Finding 2 cited the Biddle 47-study meta-analysis: *"interventions that combined positive reinforcement with goal-setting produced larger effect sizes than those relying on restriction or negative feedback."* IRIS's verdict was unambiguous: *"The Chibi thriving (positive reinforcement) is architecturally superior to a tree dying (punishment)."*
